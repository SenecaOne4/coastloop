...
revoke all on function public.record_playback_atomic(uuid, date, uuid, uuid, uuid, numeric, timestamptz) from public;
revoke all on function public.record_playback_atomic(uuid, date, uuid, uuid, uuid, numeric, timestamptz) from anon;
revoke all on function public.record_playback_atomic(uuid, date, uuid, uuid, uuid, numeric, timestamptz) from authenticated;
